...
const features = [
  { icon: "🧠", title: "AI Summarization", desc: "Get concise summaries of any YouTube video powered by Google Gemini." },
...
const steps = [
  ...
  { n: "2", title: "AI fetches and summarizes", desc: "Our system fetches the transcript and sends it to Gemini AI to generate a smart summary." },
  ...
  return (
    <div style={{ background: t.bg, minHeight: "100vh", fontFamily: "'Outfit', sans-serif", color: t.text }}>
      ...
      >
        ...
        {/* Nav links */}
        <div style={{ display: "flex", alignItems: "center", gap: "2px", background: t.bgSecondary, borderRadius: "100px", padding: "4px" }}>
      ...
      {/* ── Hero ── */}
      <section style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "580px", borderBottom: `1px solid ${t.border}` }}>
        {/* Left */}
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "64px 56px", borderRight: `1px solid ${t.border}` }}>
          ...
          <h1 style={{ fontSize: "54px", fontWeight: 900, lineHeight: 1.05, letterSpacing: "-3px", color: t.text, marginBottom: "18px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", marginBottom: "32px" }}>
            {user ? (
              <Link to="/dashboard" style={{ textDecoration: "none" }}>
                <button
                  style={{ padding: "13px 28px", borderRadius: "100px", border: "none", background: t.btnPrimary, fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: "14px", color: t.btnPrimaryText, cursor: "pointer", transition: "background 0.2s" }}
                  onMouseOver={(e) => (e.currentTarget.style.background = t.btnPrimaryHover)}
                  onMouseOut={(e) => (e.currentTarget.style.background = t.btnPrimary)}
                >
                  Go to Dashboard →
            ...
            <button
              style={{ padding: "13px 28px", borderRadius: "100px", border: `1.5px solid ${t.btnSecondaryBorder}`, background: t.bgCard, fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: "14px", color: t.text, cursor: "pointer", transition: "border-color 0.2s" }}
              onMouseOver={(e) => (e.currentTarget.style.borderColor = t.text)}
              onMouseOut={(e) => (e.currentTarget.style.borderColor = t.btnSecondaryBorder)}
            >
              ▶ Watch demo
          ...
          {/* URL bar */}
          <div style={{ display: "flex", alignItems: "center", background: t.bgSecondary, borderRadius: "14px", padding: "6px 6px 6px 16px", maxWidth: "420px" }}>
            ...
            />
            <button style={{ padding: "9px 16px", borderRadius: "10px", border: "none", background: t.btnPrimary, fontFamily: "'Outfit', sans-serif", fontSize: "12px", fontWeight: 700, color: t.btnPrimaryText, cursor: "pointer", whiteSpace: "nowrap" }}>
              ✨ Summarize
            </button>
          </div>
        </div>

        {/* Right — hero image fills full panel */}
        <div style={{ position: "relative", overflow: "hidden", background: t.bgCard, minHeight: "580px" }}>
          <img src="/hero.png" alt="Notetube hero"
            style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center", mixBlendMode: isDark ? "screen" : "multiply", display: "block" }}
          />
          <div style={{ position: "absolute", top: "28px", right: "28px", background: t.bgCard, borderRadius: "12px", padding: "9px 14px", fontSize: "12px", fontWeight: 700, color: t.text, boxShadow: t.shadowCard, zIndex: 2 }}>
            📝 Notes saved instantly
          </div>
          <div style={{ position: "absolute", bottom: "32px", left: "28px", background: t.invertedBg, borderRadius: "12px", padding: "9px 14px", fontSize: "12px", fontWeight: 700, color: t.invertedText, boxShadow: t.shadowCard, zIndex: 2 }}>
      ...
      <section style={{ padding: "80px 48px", maxWidth: "1000px", margin: "0 auto" }}>
        <h2 style={{ fontSize: "40px", fontWeight: 900, textAlign: "center", letterSpacing: "-2px", marginBottom: "10px", color: t.text }}>Everything you need</h2>
      ...
      {/* ── How it works ── */}
      <section style={{ padding: "80px 48px", background: t.invertedBg }}>
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          <h2 style={{ fontSize: "40px", fontWeight: 900, textAlign: "center", letterSpacing: "-2px", marginBottom: "10px", color: t.invertedText }}>How it works</h2>
      ...
      <section style={{ padding: "80px 48px", textAlign: "center" }}>
        <div style={{ maxWidth: "520px", margin: "0 auto", background: t.bgSecondary, borderRadius: "28px", padding: "64px 48px" }}>
          <h2 style={{ fontSize: "40px", fontWeight: 900, letterSpacing: "-2px", marginBottom: "14px", lineHeight: 1.1, color: t.text }}>Ready to learn<br />smarter?</h2>
          ...
          {user ? (
            <Link to="/dashboard" style={{ textDecoration: "none" }}>
              <button
                style={{ padding: "14px 36px", borderRadius: "100px", border: "none", background: t.btnPrimary, fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: "14px", color: t.btnPrimaryText, cursor: "pointer", transition: "background 0.2s" }}
                onMouseOver={(e) => (e.currentTarget.style.background = t.btnPrimaryHover)}
                onMouseOut={(e) => (e.currentTarget.style.background = t.btnPrimary)}
